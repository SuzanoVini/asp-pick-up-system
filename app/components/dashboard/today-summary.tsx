import { AlertCircle, School, Truck, UserCheck, Users, UserX } from "lucide-react";
...
export function TodaySummary({
	...
	return (
		<div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
			<StatCard label="Schools Served" value={schoolsServed} icon={School} color="text-blue-500" />
